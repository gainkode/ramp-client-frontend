(function (window) {
    ...
    // Coockie domain
    window.__env_data.cookieDomain = 'testnet.getcoins.com.au';
    // Current client host address
    window.__env_data.client_host = 'https://testnet.getcoins.com.au';
    // API server address
    window.__env_data.api_server = 'https://testnet.getcoins.com.au';
    // API WebSocket address
    window.__env_data.ws_server = 'wss://testnet.getcoins.com.au';
    // Image hosting address
    window.__env_data.image_host = 'https://testnet.getcoins.com.au';
    // API time out
    ...
    // Recaptcha ID
    window.__env_data.recaptchaId = '6Ldi8YUgAAAAAP7aQ0pBN9LiHS1LehoXlwYCDyct';
    // Google ID
    ...
    window.__env_data.support_email = 'support@getcoins.com.au';
    // Base color number
