(function (window) {
    ...
    //////////////////////////////////////////////////
    // Base color number
    window.__env_data.base_color = '#44C0C6';
    // White color
    ...
    window.__env_data.color_purple_900 = '#1E0143';  // top menu bar
    window.__env_data.color_purple_800 = '#312244';
    window.__env_data.color_purple_700 = '#473b57';
    window.__env_data.color_purple_600 = '#594f66';
    window.__env_data.color_purple_500 = '#72697c';
    window.__env_data.color_purple_400 = '#857f8d';
    window.__env_data.color_purple_300 = '#b7b2bd';
    window.__env_data.color_purple_200 = '#afabb4';
    window.__env_data.color_purple_100 = '#dcd8e2';
    window.__env_data.color_purple_50 = '#ede8f3';
    // Blue colors (buttons, titles, icons)
    window.__env_data.color_main_blue_900 = '#287377';
    window.__env_data.color_main_blue_800 = '#37a3a8';
    window.__env_data.color_main_blue_700 = '#44C0C6'; // main color
    window.__env_data.color_main_blue_600 = '#49cfd6';
    window.__env_data.color_main_blue_500 = '#4bdee6';
    window.__env_data.color_main_blue_400 = '#59eaf1';
    window.__env_data.color_main_blue_300 = '#6eeef5';
    window.__env_data.color_main_blue_200 = '#7aedf3';
    window.__env_data.color_main_blue_100 = '#8ef0f5';
